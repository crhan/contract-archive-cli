...
- 公司/机构/品牌名（**中文与英文都要**，如某企业的中文名及其英文名 XX GROUP）→ 示例置业有限公司、示例科技有限公司…
- 楼盘/小区/项目/园区/大厦名（如「XX花园」「XX苑」「XX大厦」「XX府」等专名）→ 示例花园、示例苑、示例大厦…
- 省/市/区/县等具体行政区划名（如「XX省」「XX市」「XX区」等专名）→ 示例省、示例市、示例区
